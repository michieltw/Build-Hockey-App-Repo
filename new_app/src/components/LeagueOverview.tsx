...
export const LeagueOverview: React.FC<LeagueOverviewProps> = ({
  ...
  const getSearchResults = () => {
    ...
    const matchedPlayers = db.persons.filter(
      (p) =>
    ...
    const matchedTeams = db.teams.filter(
      (t) =>
    ...
    const matchedEvents = (db.calendarEvents || []).filter(
      (e) =>
    ...
    const rules = [
      ...
      {
        id: "contact",
        title: "Fysiek Contact & Checking",
        desc: "In de House League is de nadruk gelegd op plezier en veiligheid. Gecontroleerd fysiek contact is toegestaan, maar gevaarlijk tackelen of boarding is streng verboden.",
      },
      {
        id: "straf",
        title: "Straftijden & Boarding",
        desc: "Kleine straffen duren 2 minuten, grote straffen duren 5 minuten en kunnen leiden tot uitsluiting.",
      },
    ];
    ...
    <div className="space-y-8 animate-fade-in" id="league-overview-page">
      ...
      <div className="bg-white/95 backdrop-blur-md border border-slate-200 rounded-3xl p-6 shadow-sm">
        ...
        <p className="text-xs text-slate-500 font-semibold mb-4">
          Typ trefwoorden om direct spelers, clubs, wedstrijden,
          speelschema&apos;s of reglementen te vinden.
        </p>
          ...
          <div className="mt-6 border-t border-slate-100 pt-5 space-y-6">
            ...
            {results.totalCount === 0 ? (
              <div className="text-center py-8 text-slate-500 text-xs italic font-semibold">
                Geen directe resultaten gevonden voor deze zoekopdracht. Probeer
                een ander trefwoord!
              </div>
            ) : (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-grow">
                      <div className="flex items-center gap-1.5">
                        <span className="text-[10px] bg-slate-100 text-slate-900 px-1.5 py-0.2 rounded font-mono font-extrabold uppercase">
                          Team
                        </span>
                      </div>
                      <h4 className="text-xs font-black text-slate-950 truncate mt-0.5">
                        {team.name}
                      </h4>
                      <p className="text-xs text-slate-500 font-semibold truncate">
                        {team.city} &bull; {team.stadium}
                      </p>
                    </div>
                  </div>
                ))}
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-grow">
                      ...
                      <p className="text-xs text-slate-500 font-semibold mt-0.5 truncate">
                        {event.date} &bull;{" "}
                        {location?.name || event.location || "Hoofdlocatie"}
                      </p>
                    </div>
                  </div>
                ))}
                ...
                {results.rules.map((rule) => (
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-grow">
                      <div className="flex items-center gap-1.5">
                        <span className="text-[10px] bg-slate-100 text-xsurple-800 px-1.5 py-0.2 rounded font-mono font-extrabold uppercase">
                          Reglement
                        </span>
                      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white/95 backdrop-blur-md border border-slate-200 rounded-3xl p-6 shadow-sm space-y-4">
          ...
          <div className="space-y-3.5 text-xs text-slate-700 font-medium leading-relaxed">
            <p>
              De <strong className="text-slate-950">De Sport Competitie</strong>{" "}
              is de ultieme recreatieve competitie voor sporters in de regio.
              Wij geloven dat sport voor iedereen is: van gedreven veteranen tot
              enthousiaste nieuwkomers die net hun eerste stappen in het veld
              zetten.
            </p>
            <p>
              Gevestigd in het prachtige{" "}
              <strong className="text-slate-950">{location.name}</strong> in
              Groningen, biedt onze competitie een veilige, gestructureerde en
              vooral ontzettend sportieve omgeving. Fair-play, plezier en
              kameraadschap staan bij ons met stip op nummer één.
            </p>
            <p>
              Met ons innovatieve management- en draft-systeem zorgen we voor
              gebalanceerde teams, waardoor elke wedstrijd een spannende strijd
              op het scherpst van de snede is. Of je nu speler bent, coach,
              scheidsrechter, of een trouwe supporter langs de boarding, deze
              competitie is jouw sport-thuis.
            </p>
          </div>

          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 pt-4 border-t border-slate-100">
            <div className="text-center p-3 bg-slate-50 border border-slate-200 rounded-xl">
              <span className="block text-xsl font-black text-slate-900 font-mono">
                4
              </span>
            ...
            <div className="text-center p-3 bg-slate-50 border border-slate-200 rounded-xl">
              <span className="block text-xsl font-black text-slate-950 font-mono">
                80+
              </span>
              <span className="text-xs font-bold text-slate-500 uppercase">
      ...
      <div className="bg-white/95 backdrop-blur-md border border-slate-200 rounded-3xl p-6 shadow-sm">
        <div className="border-b border-slate-100 pb-3 mb-6">
          ...
          <p className="text-xs text-slate-500 font-semibold mt-0.5">
            Heb je vragen over inschrijvingen, regelgeving of wil je lid worden?
            Neem direct contact op met het het bestuur.
          </p>
        </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start space-x-3 p-3 bg-slate-50 border border-slate-200 rounded-xl">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 font-medium select-all">
                    info@groningenhouseleague.nl
                  </p>
                </div>
              </div>
            ...
            <div className="border border-slate-200 rounded-xl overflow-hidden shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] relative h-36 bg-slate-100 flex items-center justify-center">
              ...
              <div className="absolute bg-white/95 px-3 py-1.5 rounded-lg border border-slate-200 shadow-sm text-center">
                ...
                <p className="text-[10px] font-bold text-slate-500">
                  Locatie Groningen House League
                </p>
              </div>
            </div>
          </div>
            ...
            {isSubmitted ? (
              <div className="border-2 border-slate-200 bg-slate-100 rounded-3xl p-8 flex flex-col items-center justify-center text-center space-y-3 animate-bounce">
                ...
                <p className="text-xs text-slate-900 max-w-sm">
                  Bedankt voor je bericht. Het het bestuur zal binnen 24 uur
                  contact met je opnemen op het opgegeven e-mailadres.
                </p>
                <button
              ...
              <form onSubmit={handleContactSubmit} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs uppercase font-black text-slate-500 mb-1">
                      Volledige Naam
                    </label>
                    <input
                      type="text"
                ...
                <div>
                  ...
                  >
                    <option value="Algemene Vraag">
                      Algemene Vraag / Informatie
                    </option>
                    <option value="Inschrijving">
                      Inschrijving nieuwe speler
                    </option>
                    <option value="Pers / Media">
                      Pers / Sponsoring aanvraag
                    </option>
                    <option value="Klacht of Melding">
                      Klacht of Geschil overdracht
                    </option>
                  </select>
                </div>
