...
export default function RinkMap({
  ...
  const [faceoffPopup, setFaceoffPopup] = useState<{
    x: number;
    y: number;
  } | null>(null);
    ...
    <>
      <section className="flex bg-[#1a1a1a] px-2 pt-2 gap-2 shrink-0 justify-between items-center text-gray-400 text-xs z-10">
        <div className="flex gap-2">
          <button
            className="glossy-button w-8 h-8 rounded-full flex items-center justify-center"
          ...
          <span className="flex items-center w-10 justify-center">
            {Math.round(zoom * 100)}%
          </span>
        </div>
        <button
          className="glossy-button px-3 py-1.5 rounded flex items-center gap-2"
          onClick={() => onRotate(90)}
        >
      ...
      <section
        ref={rinkContainerRef}
        className="relative bg-white mx-2 mt-2 mb-2 rounded-[40px] shrink-0 h-[280px] border-4 border-black shadow-lg overflow-hidden"
      >
        <div
              ...
              .map((e) => (
                <div
                  ...
                  style={{
                    ...
                    top: `${e.y}%`,
                    backgroundColor:
                      e.team === homeTeam ? homeColor : awayColor,
                  }}
                />
              ))}
          </div>
        ...
        {!isRunning && !isFaceoffMode && (
          <div className="absolute inset-0 bg-black/75 z-40 flex flex-col items-center justify-center p-2 text-center">
            ...
            <div className="grid grid-cols-3 gap-2 w-full max-w-md px-2">
              ...
              >
                <img
                  src="https://cdn.shopify.com/s/files/1/1038/7203/7203/files/puckicon.png?v=1786143386"
                  alt="Icing"
                  className="w-8 h-8 object-contain drop-shadow-md"
                />
                <span className="text-white text-[9px] font-bold uppercase tracking-wider truncate max-w-full px-0.5">
                  {labels?.icing || ""}
                </span>
              </button>
              ...
              >
                <img
                  src="https://cdn.shopify.com/s/files/1/1038/7203/7203/files/skateicon.png?v=1786143386"
                  alt="Offside"
                  className="w-8 h-8 object-contain drop-shadow-md"
                />
                <span className="text-white text-[9px] font-bold uppercase tracking-wider truncate max-w-full px-0.5">
              ...
              >
                <img
                  src="https://cdn.shopify.com/s/files/1/1038/7203/7203/files/lampicon.png?v=1786143386"
                  alt="Goal"
                  className="w-8 h-8 object-contain drop-shadow-md"
                />
                <span className="text-white text-[9px] font-bold uppercase tracking-wider truncate max-w-full px-0.5">
              ...
              >
                <img
                  src="https://cdn.shopify.com/s/files/1/1038/7203/7203/files/reficon.png?v=1786143386"
                  alt="Penalty"
                  className="w-8 h-8 object-contain drop-shadow-md"
                />
                <span className="text-white text-[9px] font-bold uppercase tracking-wider truncate max-w-full px-0.5">
              ...
              >
                <img
                  src="https://cdn.shopify.com/s/files/1/1038/7203/7203/files/saveicon.png?v=1786143386"
                  alt="Save"
                  className="w-8 h-8 object-contain drop-shadow-md"
                />
                <span className="text-white text-[9px] font-bold uppercase tracking-wider truncate max-w-full px-0.5">
              ...
              >
                <img
                  src="https://cdn.shopify.com/s/files/1/1038/7203/7203/files/finalicon.png?v=1786143386"
                  alt="End Game"
                  className="w-8 h-8 object-contain drop-shadow-md"
                />
                <span className="text-white text-[9px] font-bold uppercase tracking-wider truncate max-w-full px-0.5">
        ...
        {faceoffPopup && (
          ...
          >
            <button
              className="glossy-button px-4 py-2 rounded text-white font-bold text-xs"
              onClick={() => {
                onFaceoff("home");
                setFaceoffPopup(null);
