      ...
      <div className="flex-1 overflow-y-auto p-4 max-w-lg mx-auto w-full flex flex-col gap-6 pt-8 pb-12">
        <div className="bg-surface-container-low metallic-border rounded-lg p-6 inner-glow flex flex-col gap-4">
          <div className="flex items-center gap-3 text-tertiary">
            ...
            <h2 className="font-mono text-[14px] font-bold tracking-widest uppercase">
              Supabase Connection
            </h2>
          </div>

          <p className="text-on-surface-variant text-sm leading-relaxed">
            Test de verbinding met je Supabase project. De omgevingsvariabelen
            worden gebruikt voor de connectie.
          </p>
            ...
            <div className="flex items-center gap-2">
              {status === "idle" && (
                <span className="text-gray-500 text-xs font-mono uppercase tracking-wider">
                  Geen connectie getest
                </span>
              )}
              {status === "testing" && (
                <>
                  <Loader2 className="w-4 h-4 text-tertiary animate-spin" />
                  <span className="text-tertiary text-xs font-mono uppercase tracking-wider">
                    Testen...
                  </span>
                </>
              )}
              ...
              {status === "error" && (
                <>
                  ...
                  <span className="text-error text-xs font-mono uppercase tracking-wider">
                    Verbindingsfout
                  </span>
                </>
              )}
